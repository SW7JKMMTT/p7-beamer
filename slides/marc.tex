...
\section{Epilogue}
    ...
    \begin{frame}{Epilogue}\framesubtitle{Major Choices}    
        ...
        \note<2-2>[item]{Did have the opportunity: would have delayed us and forced a \textbf{security focus}Partially why focus group}
        \note<2-2>[item]{Not having one: \textbf{Partially why focus did not matter} a lot.}
        %\note<3-3>[item]{}
    \end{frame}
