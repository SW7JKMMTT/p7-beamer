...
\title{Giraf}
\subtitle[Exam]{Exam}
\author[SW615F16]{Group SW615F16}
\date{14\textsuperscript{th} of June 2016}
...
\begin{frame}[noframenumbering]{Introduction}
  \begin{multicols}{2}
    \tableofcontents
  \end{multicols}
  \note[item]{Intro \& Scrum of scrums - Thomas}
  \note[item]{Better code quality - Caspar}
  \note[item]{REST server - Jesper}
  \note[item]{REST client, evaluation - Nikolaj}
\end{frame}
